      ...
      <section className="mx-auto max-w-7xl px-5 sm:px-8">
        <Reveal>
          ...
          <p className="mt-3 max-w-lg text-cream/70">
            En plein cœur de la Rue Colorée. 100% à emporter · appelez pour préparer votre commande.
          </p>
        </Reveal>
      </section>
          ...
          <div className="space-y-5">
            ...
            <Reveal delay={100} className="rounded-2xl border border-red/30 bg-gradient-to-br from-red/10 to-panel p-7">
              ...
              <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                <Btn href={CONTACT.reservation} target="_blank" tone="red" className="flex-1">
                  <IconCalendar size={18} /> Réserver une table
                </Btn>
                <Btn href={CONTACT.ubereats} target="_blank" variant="outline" tone="green" className="flex-1">
                  <IconBike size={18} /> Uber Eats
                </Btn>
              </div>
              <div className="mt-3 flex flex-col gap-3 sm:flex-row">
                <Btn href={"tel:" + CONTACT.phoneTel} variant="outline" tone="red" className="flex-1">
